...
int main()
{
	...
	if (menu == 1)
	{
		...
		if (menu == 1 && kuantitas >= 3) // Memilih menu 1 dan jika paket yang dipesan 3 atau lebih
		{
	...
	else if (menu == 3)
	{
		...
		if(menu == 3 && kuantitas >= 3) // Memilih menu 3 dan jika paket yang dipesan 3 atau lebih
		{
			printf("\nTotal pembelian kamu adalah %.f paket. Kamu berhak mendapat diskon sebanyak 6 persen!\n", kuantitas );
